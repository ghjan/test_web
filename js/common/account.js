...
define([
    ...
    'validate',
    'validateExpand'
], function($, utils, ui, weixin, services, template) {
    ...
    var _loginNew = function(callback) {
        ...
        $('body').append('<a href="javascript:;" class="mark-close J-Mark-Close"><img src="http://'+ window.g_config.staticHost +'/static/iyun/images/y3/common/mask-close.png" /></a>');
